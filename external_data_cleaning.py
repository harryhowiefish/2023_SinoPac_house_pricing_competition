...
def ext_cleaning(path:str):
    """
    Description:combine and simplify external data (only keeping location type) to a single csv
    ...
    external_simplified.to_csv(f'{path}/external_transformed_simplified.csv',index=False)